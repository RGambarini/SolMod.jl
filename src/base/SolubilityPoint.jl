...
2. e_1 = Boolean to determine the solubility of the i component in the solution. Automatically set to true. If e_2 is also true, the solubility of the racemate product will be determined
3. e_2 = Boolean to determine the solubility of the j component in the solution. Automatically set to true. If e_1 is also true, the solubility of the racemate product will be determined
